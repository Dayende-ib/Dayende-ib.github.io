          ...
          <div className="section-panel card-glow rounded-[28px] p-4 sm:p-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat, index) => {
                ...
                const rawValue = t(stat.valueKey);
                return (
                  <AnimatedSection key={stat.labelKey} direction="up" delay={index * 0.08}>
                    <Card className="rounded-2xl border-border/70 bg-background/45 shadow-none card-hover-glow">
