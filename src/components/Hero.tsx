  ...
  return (
    <section id="accueil" className="relative overflow-hidden pt-28 pb-20">
      <div className="absolute inset-0 -z-10">
        ...
        {/* Floating orbs */}
        <div className="animate-float absolute -top-20 left-1/4 h-72 w-72 rounded-full bg-cyan-500/[0.08] blur-3xl" />
        <div className="animate-float-slow absolute top-40 right-1/4 h-56 w-56 rounded-full bg-sky-500/10 blur-3xl" />
        <div className="animate-float absolute bottom-10 left-10 h-40 w-40 rounded-full bg-violet-500/[0.08] blur-2xl" style={{ animationDelay: "2s" }} />
      </div>
            ...
            <AnimatedSection direction="up" delay={0.1}>
              <div className="flex flex-wrap gap-3">
                <Button
                  asChild
                  size="lg"
                  className="h-11 rounded-full px-6 bg-gradient-to-r from-cyan-500 to-sky-500 hover:from-cyan-400 hover:to-sky-400 text-background font-semibold shadow-lg shadow-cyan-500/25"
                >
            ...
            <AnimatedSection direction="up" delay={0.18}>
              <div className="grid gap-3 sm:grid-cols-3">
                {proofKeys.map((key) => (
                  <div
                    key={key}
                    className="section-panel card-glow card-hover-glow rounded-2xl px-4 py-4"
                  >
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-3">
                  {spotlightKeys.map((item) => (
                    <div
                      key={item}
                      className="rounded-2xl border border-border/70 bg-background/40 p-4 card-hover-glow hover:border-cyan-400/30"
                    >
